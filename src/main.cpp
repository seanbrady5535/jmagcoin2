...
// Copyright (c) 2013-2014 The JMAGcoin developers
...
#if defined(NDEBUG)
# error "JMAGcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "JMAGcoin Signed Message:\n";
...
//TODO: this isn't identical to JMAGcoin reference client.
...
static const int64_t nTargetTimespan = 4 * 60 * 60; // JMAGcoin: every 4 hours
static const int64_t nTargetTimespanNEW = 60 ; // JMAGcoin: every 1 minute
static const int64_t nTargetSpacing = 60; // JMAGcoin: 1 minute
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // JMAGcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
void ThreadScriptCheck() {
    RenameThread("JMAGcoin-scriptch");
...
bool ConnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // BIP16 was always active in JMAGcoin
...
{
    // JMAGcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
