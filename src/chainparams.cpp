...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("JMAGcoin.com", "seed.JMAGcoin.com"));
        ...
        vSeeds.push_back(CDNSSeedData("JMAGchain.info", "seed.JMAGchain.info"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testJMAG.lionservers.de", "testJMAG-seed.lionservers.de"));
        vSeeds.push_back(CDNSSeedData("lionservers.de", "testJMAG-seed-static.lionservers.de"));
